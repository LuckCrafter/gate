...
import (
	...
	"github.com/luckcrafter/gate/pkg/edition"
	bconfig "github.com/luckcrafter/gate/pkg/edition/bedrock/config"
	bproxy "github.com/luckcrafter/gate/pkg/edition/bedrock/proxy"
	jconfig "github.com/luckcrafter/gate/pkg/edition/java/config"
	jproxy "github.com/luckcrafter/gate/pkg/edition/java/proxy"
	"github.com/luckcrafter/gate/pkg/gate/config"
	"github.com/luckcrafter/gate/pkg/internal/otelutil"
	"github.com/luckcrafter/gate/pkg/internal/reload"
	"github.com/luckcrafter/gate/pkg/runtime/process"
	connectcfg "github.com/luckcrafter/gate/pkg/util/connectutil/config"
	errorsutil "github.com/luckcrafter/gate/pkg/util/errs"
	"github.com/luckcrafter/gate/pkg/util/interrupt"
)
